...
@interface QZHomeViewController ()<UITableViewDelegate,UITableViewDataSource,UIViewControllerPreviewingDelegate>
...
- (void)gobackToHome {
    ...
    QZSearchController * search = [[QZSearchController alloc] init];
...
- (nullable UIViewController *)previewingContext:(id <UIViewControllerPreviewing>)previewingContext viewControllerForLocation:(CGPoint)location {
    ...
    QZPopViewController1 *childVC = [[QZPopViewController1 alloc] init];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    QZPopViewController1 * testVC = [[QZPopViewController1 alloc] init];
